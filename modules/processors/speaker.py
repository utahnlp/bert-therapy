      ...
      for (idx, line) in enumerate(json_file):
        ...
        for context_message in context:
          ...
          if context_message['turn_number'] == -1:
            continue
          context_utterance = f"<{context_message['speaker']}>" + context_message['utterance']
